...
class BetterPlayerControlsConfiguration {
  ...
  const BetterPlayerControlsConfiguration(
      ...
      this.positionStyle,
      this.modalTextStyle,
      this.playWidget = const SizedBox.shrink(),
      this.qualityWidget = const SizedBox.shrink(),
      this.pauseWidget = const SizedBox.shrink(),
      ...
      this.muteIcon = const SizedBox.shrink(),
      this.unMuteIcon = const SizedBox.shrink(),

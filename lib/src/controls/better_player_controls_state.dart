...
abstract class BetterPlayerControlsState<T extends StatefulWidget>
  ...
  Widget _buildTrackRow(BetterPlayerHlsTrack track, String? preferredName) {
    ...
    final String trackName = preferredName ?? "${track.height}";
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            Text(
              trackName,
              style: betterPlayerControlsConfiguration.modalTextStyle ??
                  TextStyle(
                    color: betterPlayerControlsConfiguration.textColor,
                    fontSize: 12.0,
                  ),
            ),
          ],

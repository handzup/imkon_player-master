      ...
      child: Container(
        ...
        child: CustomAnimatedIcon(
          ...
          child: Padding(
              ...
              child: _controlsConfiguration.qualityWidget),
        ),
      ),
    );
  }
        ...
        child: Container(
          ...
          child: Center(
            child: _betterPlayerController!.isFullScreen
                ? _controlsConfiguration.fullscreen_exit
                : _controlsConfiguration.fullscreen,
          ),
        ),
      ),
    );
            ...
            child: GestureDetector(
              ...
              child: Container(
                child: _latestValue!.isPlaying
                    ? _controlsConfiguration.pauseWidget
                    : _controlsConfiguration.playWidget,
              ),
            ),
          ),
        ),
  ...
  Widget _buildPosition() {
    ...
    return Padding(
      ...
      child: Text(
        ...
        style: _controlsConfiguration.positionStyle ??
            TextStyle(
              fontSize: 10,
